...
describe("AppNavbar tests", () => {
  ...
  test("Restaurants, Articles, UCSB Dates, MenuItemReview, Help Requests, Dining Commons Menu Items, and RecommendationRequest links do NOT show when not logged in", async () => {
