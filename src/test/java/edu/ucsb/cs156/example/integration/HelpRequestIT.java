...
public class HelpRequestIT {
  ...
  public void test_that_logged_in_user_can_get_by_id_when_the_id_exists() throws Exception {
    // arrange
    LocalDateTime requestTime = LocalDateTime.parse("2024-01-15T10:30:00");
    ...
    HelpRequest helpRequest =
        HelpRequest.builder()
            ...
            .explanation("Need help with Swagger annotations")
            .solved(false)
            .build();
  ...
  public void an_admin_user_can_post_a_new_help_request() throws Exception {
    ...
    MvcResult response =
        mockMvc
            .perform(
                post("/api/helprequests/post?requesterEmail=student@ucsb.edu&teamId=s26-09&tableOrBreakoutRoom=Table 5&requestTime=2024-01-15T10:30:00&explanation=Need help with Swagger annotations&solved=false")
                    .with(csrf()))
